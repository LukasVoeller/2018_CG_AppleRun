...
bool LoadPNG::loadPNGImage(char *name, int &outWidth, int &outHeight, bool &outHasAlpha, GLubyte **outData) {
	png_structp png_ptr;
	png_infop info_ptr;
...
void LoadPNG::mousePassive(int x, int y){
	mouseX = x;
	mouseY = y;
}

void LoadPNG::mouseMotion(int x, int y){
	const float SPEED = 2;
